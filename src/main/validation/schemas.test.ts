...
describe('SiteConfigSchema', () => {
  ...
  it('should reject empty domain', () => {
    ...
    expect(() => SiteConfigSchema.parse(invalidConfig)).toThrow('Domain is required')
  })
  ...
  it('should reject invalid domain format', () => {
    ...
    expect(() => SiteConfigSchema.parse(invalidConfig)).toThrow('Invalid domain format')
  })
...
describe('SettingsSchema', () => {
  ...
  it('should reject empty webroot path', () => {
    ...
    expect(() => SettingsSchema.parse(invalidSettings)).toThrow('Webroot path is required')
  })
...
describe('WpCliCommandSchema', () => {
  ...
  it('should reject empty command', () => {
    ...
    expect(() => WpCliCommandSchema.parse(invalidCommand)).toThrow('Command is required')
  })
