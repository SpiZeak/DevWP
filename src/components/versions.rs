            ...
            ul { class: "space-y-4",
                li { class: "flex justify-between items-center",
                    div { class: "flex items-center gap-2",
                        ...
                        span { class: "text-muted text-xs uppercase tracking-wide", "DevWP" }
                    }
                ...
                li { class: "flex justify-between items-center",
                    div { class: "flex items-center gap-2",
                        ...
                        span { class: "text-muted text-xs uppercase tracking-wide", "Developer" }
                    }
                    a {
                        href: "https://trewhitt.au",
                        target: "_blank",
                        rel: "noopener noreferrer",
                        class: "font-medium text-accent text-sm hover:underline no-underline",
                        onclick: move |ev| {
                            ev.prevent_default();
