...
describe('XdebugSwitch', () => {
  ...
  it('should display performance mode description when disabled', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(
          /Performance mode disables Xdebug for faster PHP execution/,
        ),
      ).toBeInTheDocument();
    });
  });
  ...
  it('should display debug mode description when enabled', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/Debug mode enables Xdebug for step debugging/),
      ).toBeInTheDocument();
    });
  });
