...
git commit -m "Initial commit: DevWP application"
...
2. Enter the version number (e.g., `0.3.3`)
...
1. Update `package.json` version (e.g., `0.3.3` → `0.3.3`)
2. Commit changes: `git commit -am "Bump version to 0.3.3"`
3. Create tag: `git tag v0.3.3`
