...
2. Enter the version number (e.g., `0.0.37`)
...
1. Update `package.json` version (e.g., `0.0.37` → `0.0.37`)
2. Commit changes: `git commit -am "Bump version to 0.0.37"`
3. Create tag: `git tag v0.0.37`
