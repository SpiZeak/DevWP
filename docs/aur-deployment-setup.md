...
2. Enter the version number (e.g., `0.2.1`)
...
1. Update `package.json` version (e.g., `0.2.1` → `0.2.1`)
2. Commit changes: `git commit -am "Bump version to 0.2.1"`
3. Create tag: `git tag v0.2.1`
