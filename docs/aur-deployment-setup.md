...
2. Enter the version number (e.g., `0.3.1`)
...
1. Update `package.json` version (e.g., `0.3.1` → `0.3.1`)
2. Commit changes: `git commit -am "Bump version to 0.3.1"`
3. Create tag: `git tag v0.3.1`
