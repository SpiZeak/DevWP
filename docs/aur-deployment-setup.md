...
2. Enter the version number (e.g., `0.0.43`)
...
1. Update `package.json` version (e.g., `0.0.43` → `0.0.43`)
2. Commit changes: `git commit -am "Bump version to 0.0.43"`
3. Create tag: `git tag v0.0.43`
